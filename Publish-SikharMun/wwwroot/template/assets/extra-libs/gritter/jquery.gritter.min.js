(function (b) {
  ...
  var a = {
    ...
    _item_count: 0,
    _is_setup: 0,
    _tclose: '<div class="gritter-close"></div>',
    _ttitle: '<span class="gritter-title">[[title]]</span>',
    _titem:
    ...
    _twrap: '<div id="gritter-notice-wrapper"></div>',
    add: function (g) {
      if (typeof g == "string") {
        g = { text: g };
      }
      ...
      if (k) {
        k = this._str_replace("[[title]]", k, this._ttitle);
      } else {
        k = "";
      }
      i = this._str_replace(
        ...
        [k, n, this._tclose, c, this._item_count, h, m],
        i
      );
